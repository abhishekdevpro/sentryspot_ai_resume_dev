  ...
  const handleATS = async () => {
    ...
    try {
      const response = await axios.get(
        `https://api.sentryspot.co.uk/api/jobseeker/ats-improve/${resumeId}?improve_by=${improveBy}`,
        {
          headers: {
            Authorization: token,
          },
...
const ResumeStrength = ({ score, strength, resumeId }) => {
  ...
  return (
    <>
      ...
      <div className="app-card-bg p-2 md:p-6 rounded-lg mb-6">
        <div className="flex flex-col gap-2 md:flex-row  justify-between items-start mb-6">
          <div>
            <h2 className="text-h2 text-brand">Resume Strength</h2>
            {/* <h1 className="text-h1 text-brand">Title</h1> */}
          ...
          <div className="flex flex-col gap-2 item-start md:items-end">
            <h3 className="text-h2 text-brand">Fix Resume</h3>
             <div className="text-end">
               <p className="text-p text-brand-light">
              We found{" "}
              <span className="text-p text-red-500">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex justify-between mb-1">
                    <span className="text-p text-brand-light">
                      {section.name}
                    </span>
