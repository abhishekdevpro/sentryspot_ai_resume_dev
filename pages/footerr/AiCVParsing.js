...
function AiCVParsing() {
  return (
    <div className="m-10 mx-40 p-5  shadow-2xl">
      ...
      Our parser can handle CVs in various formats, such as PDF, DOC, DOCX, and
      TXT. This flexibility ensures that no matter how candidates submit their
      CVs, our tool can process and analyze them efficiently.
      <h1 className="text-sm font-semibold my-2">
      ...
      Our AI CV parsing tool integrates seamlessly with your Applicant Tracking
      System (ATS), automatically matching candidate profiles with job
      descriptions. This automation reduces manual effort and ensures that only
      the most relevant candidates are shortlisted.
      <h1 className="text-sm font-semibold my-2">
        5. Skill and Keyword Extraction
      </h1>
      The parser identifies and extracts key skills and keywords from CVs,
      comparing them against the job requirements. This ensures that candidates
      who meet the necessary criteria are prioritized, improving the quality of
      your candidate pool.
      <h1 className="text-sm font-semibold my-2">
        6. Customizable Parsing Rules
      </h1>
      Tailor the parsing rules to match your specific hiring needs. You can
      define the criteria for extracting and prioritizing information, ensuring
      ...
      Access the parsed data through an intuitive dashboard. Review and analyze
      candidate profiles, compare qualifications, and filter candidates based on
      your specific criteria.
      <h1 className="text-sm font-semibold my-2">
        Step 4: Automate Candidate Matching
      </h1>
      Integrate the parsed data with your ATS to automate the candidate matching
      process. The AI matches candidates profiles with job descriptions,
      ensuring that only the most qualified candidates are shortlisted.
      <h1 className="text-sm font-semibold my-2">
      ...
      Provide a smoother and faster recruitment experience for candidates. With
      quick and accurate CV processing, candidates receive timely feedback and
      updates.
      <h1 className="text-sm font-semibold my-2">Scalability</h1>
      Handle large volumes of CVs effortlessly. Our AI CV parsing tool can scale
      to meet the demands of high-volume recruitment campaigns, ensuring that no
      ...
      Ready to transform your recruitment process? Visit our AI CV Parsing page
      and start optimizing your candidate selection today!
    </div>
  );
}
