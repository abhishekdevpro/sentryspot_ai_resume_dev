...
function AiSkillTests() {
  return (
    <div className="m-10 mx-40 p-5  shadow-2xl">
      ...
      Our AI Skill Tests cover a wide range of skills across various industries,
      including technical skills, soft skills, and role-specific competencies.
      Whether you re hiring for IT, marketing, finance, or any other field, our
      tests can be tailored to meet your specific needs.
      <h1 className="text-sm font-semibold my-2">
        2. Real-Time Results and Analytics
      </h1>
      Receive instant results and detailed analytics on candidates performance.
      Our AI analyzes the test outcomes to provide insights into each candidates
      strengths and areas for improvement, helping you make data-driven hiring
      decisions.
      <h1 className="text-sm font-semibold my-2">
        3. Customizable Test Formats
      </h1>
      Design tests that align with your hiring requirements. You can choose from
      multiple question formats, including multiple-choice, coding challenges,
      case studies, and situational judgment tests. Customize the difficulty
      level and duration to match the job role.
      <h1 className="text-sm font-semibold my-2">4. Unbiased Evaluation</h1>
      Our AI Skill Tests eliminate human biases from the evaluation process. The
      AI objectively scores each test based on predefined criteria, ensuring a
      ...
      the candidates performance. This ensures an accurate measurement of their
      skill level and provides a more personalized testing experience.
      ...
      Systems (ATS). This allows you to manage candidates, track their progress,
      and view test results all in one place, streamlining your recruitment
      workflow.
      ...
      Determine the skills and competencies you need to assess for the specific
      job role. Our team can help you outline the key criteria and design a
      customized test.
      ...
      data-driven hiring decisions. The comprehensive assessment results ensure
      you select the most qualified candidates for your organization.
      ...
      Automate the initial screening process and reduce the time spent on manual
      evaluations. Our AI Skill Tests provide quick and accurate assessments,
      ...
      Reduce the costs associated with traditional hiring methods. Our AI Skill
      Tests minimize the need for multiple interview rounds and help you
