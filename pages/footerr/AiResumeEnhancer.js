...
function AiResumeEnhancer() {
  return (
    <div className="m-10 mx-40 p-5  shadow-2xl">
      ...
      Our AI analyzes your resume content to ensure it is concise, relevant, and
      impactful. It helps you highlight key achievements, skills, and
      ...
      It then suggests incorporating these keywords into your resume to increase
      ...
      Our AI emphasizes your most relevant skills based on the job description.
      It ensures that your resume showcases your strengths in a way that aligns
      ...
      Receive recommendations on improving the visual layout of your resume. The
      AI ensures that your resume is not only informative but also aesthetically
      ...
      errors. This ensures your resume is polished and professional, free of any
      ...
      Upload your existing resume to the SentrySpotplatform. Our AI will start
      analyzing your document immediately.
      <h1 className="text-sm font-semibold my-2">Step 2: AI Analysis</h1>
      The AI evaluates your resume, examining content, structure, keywords, and
      overall presentation. It identifies areas that need improvement and
      generates a comprehensive enhancement plan.
      <h1 className="text-sm font-semibold my-2">
        Step 3: Receive Recommendations
      </h1>
      Within minutes, you’ll receive detailed recommendations on how to enhance
      your resume. The AI provides actionable insights and specific suggestions
      for improvement.
      <h1 className="text-sm font-semibold my-2">
        Step 4: Implement Enhancements
      </h1>
      Make the suggested changes to your resume. Use the AI’s feedback to refine
      content, optimize keywords, and improve the visual layout.
      ...
      Receive tailored recommendations that address your unique career goals and
      the specific requirements of your target job.
      <h1 className="text-sm font-semibold my-2">Efficiency and Convenience</h1>
      ...
      Ready to elevate your resume? Visit our AI Resume Enhancer page and start
      refining your resume today!
    </div>
  );
}
