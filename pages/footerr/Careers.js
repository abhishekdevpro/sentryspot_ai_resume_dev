...
function Careers() {
  return (
    <div className="m-10 mx-40 p-5  shadow-2xl">
      ...
      We foster a culture of innovation and continuous learning. Our team stays
      ahead of industry trends, ensuring that we provide cutting-edge services
      to our clients. You’ll have the opportunity to work with the latest tools
      and techniques in resume writing and career coaching.
      <h1 className="text-2xl font-semibold my-2 mt-5">
      ...
      Your work at SentrySpotwill have a direct impact on our clients’ lives. By
      ...
      ongoing training and professional development opportunities, enabling you
      to enhance your skills and advance your career. Whether you’re a seasoned
      professional or just starting out, we provide a clear path for your career
      progression.
      <h1 className="text-2xl font-semibold my-2 mt-5 underline">
        Current Openings
      </h1>
      ...
      navigating their job search. You’ll assist with interview preparation, job
      search strategies, and career planning, helping clients make informed
      ...
      professional presence. You’ll create compelling profiles that effectively
      showcase clients’ skills and experiences, connecting them with potential
