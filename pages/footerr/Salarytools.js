...
function Salarytools() {
  return (
    <div className="m-10 mx-40 p-5  shadow-2xl">
      ...
      Statistics (BLS) and professional associations often publish these reports
      annually.
      <h1 className="text-lg font-semibold my-2 mt-5 ">
      ...
      understand how far your salary will go in different cities. Websites like
      Numbeo and Expatistan provide detailed comparisons of living expenses,
      ...
      Websites like Glassdoor and Indeed offer company reviews where current and
      former employees share their experiences, including information about
      salaries and benefits. Reviewing these insights can give you a sense of
      what to expect from a potential employer and help you gauge whether their
      compensation packages are competitive.
      <h1 className="text-lg font-semibold my-2 mt-5 ">
        How SentrySpotCan Help
      </h1>
      ...
      conversations and secure a compensation package that reflects your value.
      <h1 className="text-lg font-semibold my-2 mt-5 ">Exclusive Resources</h1>
      As a SentrySpotclient, you’ll gain access to exclusive resources,
      including industry reports, salary surveys, and negotiation workshops. Our
      comprehensive toolkit ensures that you have all the information and skills
